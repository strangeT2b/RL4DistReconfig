...
# Evaluate Qwen3-8B with vLLM author-format + system loss.
...
BASE_MODEL="${BASE_MODEL:-runs/qwen3_8b/merged/sft_ce_ep3}"
ADAPTER_PATH="${ADAPTER_PATH:-}"
ADAPTER_NAME="${ADAPTER_NAME:-qwen3_8b_sft_ce_merged}"
OUTPUT_DIR="${OUTPUT_DIR:-outputs/qwen3_8b_sft_ce_merged__on__train_33_69_84_nodes_test}"
SPLIT="${SPLIT:-test}"
PROMPT_FORMAT="${PROMPT_FORMAT:-qwen_chat}"
