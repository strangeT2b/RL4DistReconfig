...
VERL_DATA_DIR="${VERL_DATA_DIR:-Dataset/verl/train_33_69_84_nodes_full_xml}"
VAL_FILES="${VAL_FILES:-${VERL_DATA_DIR}/validation.parquet}"
PREPARE_DATA="${PREPARE_DATA:-0}"
MODEL_PATH="${MODEL_PATH:-runs/llama31_8b_instruct/merged/sft_full_xml_ce_ep3__on__train_33_69_84_nodes_final}"
OUTPUT_ROOT="${OUTPUT_ROOT:-runs/llama31_8b_instruct}"
RUN_NAME="${RUN_NAME:-grpo_fullxml_nokl_norm_uniform_lr5e-6_g8_genbs32_mb1_steps300}"
...
MAX_RESPONSE_LENGTH="${MAX_RESPONSE_LENGTH:-1200}"
...
REWARD_FUNCTION_NAME="${REWARD_FUNCTION_NAME:-compute_score_full_xml_uniform}"
