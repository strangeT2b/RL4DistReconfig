...
singularity exec --nv --overlay /path/to/pytorch-example/my_pytorch.ext3:ro /scratch/work/public/singularity/cuda12.3.2-cudnn9.0.0-ubuntu-22.04.4.sif /bin/bash -c \
            "source activate /vast/user_name/penv_v2; source /ext3/env.sh;  python /path/to/LLM-Reconfiguration/Model-Notebooks/llama2-notebooks/grid-reconfiguration.py \
            --data_path /path/to/LLM-Reconfiguration/Dataset-Notebooks/train_files/train_33_69_84_nodes.csv \
            --model_id meta-llama/Llama-2-7b-hf \
            --output_model /path/to/LLM-Reconfiguration/AutoTrain/llama2/model_name \
            --num_train_epochs 10 \
            --batch_size 4 \
            --model_name_hf hf_model_name \
            --tokenizer_name_hf hf_tokenizer_name \
            --custom_loss 0 \
            --custom_loss_config IEL,SUL,CYL \
            --cycles_loss_scaling_factor 1 \
            --model_for_generation_path /path/to/LLM-Reconfiguration/AutoTrain/llama2/model_name/checkpoint-14600/ \
            --max_new_tokens 1200 "
