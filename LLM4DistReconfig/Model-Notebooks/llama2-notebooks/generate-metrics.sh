...
#SBATCH --output="/path/to/LLM-Reconfiguration/AutoTrain/llama2/out_file_name.out"
#SBATCH --nodes=1
...
singularity exec --nv --overlay /path/to/pytorch-example/my_pytorch.ext3:ro /scratch/work/public/singularity/cuda12.3.2-cudnn9.0.0-ubuntu-22.04.4.sif /bin/bash -c \
            "source /ext3/env.sh;  python /path/to/LLM-Reconfiguration/Model-Notebooks/llama3-notebooks/generate-metrics.py \
            --data_path /path/to/LLM-Reconfiguration/Dataset-Notebooks/train_files/train_33_69_84_nodes.csv \
            --model_id /path/to/LLM-Reconfiguration/AutoTrain/llama2/model_name/checkpoint-21900 \
            --model_for_generation_path /path/to/LLM-Reconfiguration/AutoTrain/llama2/model_name/checkpoint-21900 \
            --max_new_tokens 1200 \
            --filename_txt /path/to/LLM-Reconfiguration/Dataset-Notebooks/evaluations/metrics/metrics_file_name.txt\
            --filename_csv /scratch/pc2442/LLM-Reconfiguration/Dataset-Notebooks/evaluations/responses/responses_file_name.csv\
            --num_samples 500 "
