...
#SBATCH --output="/path/to/LLM-Reconfiguration/AutoTrain/llama3/model_name.out"
#SBATCH --nodes=1
...
singularity exec --nv --overlay /path/to/pytorch-example/my_pytorch.ext3:ro /scratch/work/public/singularity/cuda12.3.2-cudnn9.0.0-ubuntu-22.04.4.sif /bin/bash -c \
            ...
            --model_for_generation_path /path/to/LLM-Reconfiguration/AutoTrain/llama3/model_name/checkpoint-26280 \
            --max_new_tokens 1400 \
